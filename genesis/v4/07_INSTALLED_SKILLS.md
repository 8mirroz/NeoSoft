# Installed Skills & Rules - Genesis v4

Этот документ фиксирует набор активных навыков (skills) и правил поведения (rules), обнаруженных и настроенных в рабочей среде для разработки **Combo Fever Engine** в игре **Neo Soft Frost**.
